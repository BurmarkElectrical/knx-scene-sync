...
snapshot at the same time. Only available for DPT 18.001 trackers - DPT
17.001 trackers don't get this button, since DPT 17.001 has no control
bit and therefore no valid "store" telegram to send.
